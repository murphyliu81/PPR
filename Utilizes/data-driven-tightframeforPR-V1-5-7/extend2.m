...
switch extmod
    ...
    case 'sym'
	I = getSymIndices(rx, ru, rd);
	y = x(I, :);
	
	I = getSymIndices(cx, cl, cr);
	y = y(:, I);
...
%get symmetric extend indices I add on 2003 3 29
function I = getSymIndices(lx, lb, le)

I = [lb+1:-1:2 , 1:lx , lx-1:-1:lx-le];
