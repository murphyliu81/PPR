...
trainnum	= 65000;									% the number of samples selected for learning
...
fileName  	= 'image/lena.png';%barbara
clear_img 	= double(imread(fileName)); 				% read image   
[h, w] 	  	= size(clear_img);  						% image size
noisy_img 	= clear_img + sigma*randn(h, w); 	% add noise
