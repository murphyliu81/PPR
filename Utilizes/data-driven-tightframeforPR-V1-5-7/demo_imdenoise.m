...
stepSize  	= 4;                       					% overlap step of data   
trainnum	= 1000;									% the number of samples selected for learning
...
fileName  	= 'barbara.png';%image/peppers256.png
...
%learnt_dict  = filter_learning(patchData, lambda_1, opts);
   load learnt_dict.mat %30.41
%learnt_dict  =  DctInit(sqrt(64)); %30.27
